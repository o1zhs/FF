...
<div class="layui-upload" style="text-align: center; margin-top: 50px;">
  ...
  <div class="layui-upload-list">
    <div class="layui-container">
      <img class="layui-upload-img" id="demo1" width="1024" height="768">
    </div>
    <button type="button" class="layui-btn" id="test2" onclick="window.location.href='result.jsp'">处理</button>
    <p id="demoText"></p>
  </div>
</div>
